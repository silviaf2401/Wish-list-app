...
routes['GET']['/dashboard']='Signin#dashboard'
routes['GET']['/wish_items/create'] = 'Signin#add'
routes['POST']['/createwishlistitem'] = 'Signin#createwishlistitem'
routes['POST']['/addtowishlist/<item_id>']='Signin#addtowishlist'
routes['POST']['/removefromwishlist/<item_id>']='Signin#removefromwishlist'
routes['POST']['/delete/<item_id>']='Signin#delete'
routes['GET']['/wish_items/<item_id>']='Signin#wish_items'
"""
